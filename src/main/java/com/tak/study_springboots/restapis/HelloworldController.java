package com.tak.study_springboots.restapis;
...
public class HelloworldController {
    ...
    @GetMapping("/helloWorldGetRequest/{name}/{Id}") // doGet 역할
    public int helloWorldGetRequest(@PathVariable String name, @PathVariable String Id) { // 이름이 같은 게 좋다.
        return 0;
    }
